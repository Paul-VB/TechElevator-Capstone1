...
namespace Capstone.Models
{
    ...
    public class VendingMachine
    {
        ...
        /// <returns>
        /// The item that the customer selected
        /// </returns>
        ...
        private void LogToFile(string pathOfFile, string eventDescription, decimal startCredit, decimal endCredit)
        {
            ...
            while (!successfulLogWrite)
            {
                try
                {
                    Console.WriteLine($"Trying to write data to log file: {logFileFullPath}...");
        ...
        public void WriteSalesReportToFile(List<string> salesReportLines)
        {
            ...
            string salesReportFullPath = Path.GetFullPath(Path.Combine(SALESREPORTFOLDER, folderFriendlyDateStamp + "-SalesReport.txt"));
